...
var nativeMessages = map[string]map[string]string{
	"en": {
		...
		"quality_notice":      "Alpha quality: 24 atomic skills and 1 orchestrator are experimental; EN/ZH-CN/JA content is machine-drafted and awaits signed human review.",
		"setup_complete":      "AnyWork is ready: %d capabilities installed for %d agent targets.",
		"setup_next":          "Next: run 'anywork demo research' and paste the prompt into your agent.",
		"demo_title":          "Ready-to-run AnyWork demos",
		"demo_choose":         "Run: anywork demo <research|meeting|automation>",
		"demo_prompt":         "Paste this into your agent:",
		"demo_chain":          "Expected capability chain:",
		"demo_outcome":        "Expected outcome:",
		"unknown_demo":        "Unknown demo: %s",
		...
		"usage":               "Usage: anywork <setup|demo|list|doctor|install|update|uninstall|recover> [options]",
	},
	"zh-CN": {
		"catalog_title":       "可用的 AnyWork 工作包",
		"quality_notice":      "Alpha 质量状态：24 个原子技能和 1 个编排器均为实验版；中、英、日内容由机器起草，尚待人工签署审校。",
		"setup_complete":      "AnyWork 已就绪：已安装 %d 项能力，覆盖 %d 个智能体目标。",
		"setup_next":          "下一步：运行“anywork demo research”，把生成的任务粘贴到智能体。",
		"demo_title":          "可直接运行的 AnyWork 演示",
		"demo_choose":         "运行：anywork demo <research|meeting|automation>",
		"demo_prompt":         "把下面内容粘贴到智能体：",
		"demo_chain":          "预期能力链：",
		"demo_outcome":        "预期结果：",
		"unknown_demo":        "未知演示：%s",
		...
		"usage":               "用法：anywork <setup|demo|list|doctor|install|update|uninstall|recover> [选项]",
	},
	"ja": {
		"catalog_title":       "利用可能な AnyWork パック",
		"quality_notice":      "Alpha 品質：24 個別スキルと 1 オーケストレーターはすべて実験版です。英語・中国語・日本語の内容は機械生成の初稿で、署名付きの人手レビューは未完了です。",
		"setup_complete":      "AnyWork の準備が完了しました：%d 能力を %d 個のエージェント対象へ導入しました。",
		"setup_next":          "次：'anywork demo research' を実行し、表示された依頼をエージェントに貼り付けてください。",
		"demo_title":          "そのまま使える AnyWork デモ",
		"demo_choose":         "実行：anywork demo <research|meeting|automation>",
		"demo_prompt":         "次をエージェントに貼り付けてください：",
		"demo_chain":          "想定される能力チェーン：",
		"demo_outcome":        "期待する成果：",
		"unknown_demo":        "不明なデモ：%s",
		...
		"usage":               "使い方：anywork <setup|demo|list|doctor|install|update|uninstall|recover> [オプション]",
	},
}
