...
[能力地图](CAPABILITIES.zh-CN.md) · [路线图](ROADMAP.zh-CN.md) · [质量标准](docs/QUALITY.zh-CN.md) · [支持矩阵](docs/SUPPORT.zh-CN.md) · [贡献指南](CONTRIBUTING.zh-CN.md)
...
可以直接安装 **7 个工作包**之一——通用工作核心、管理与领导力、产品与运营、研究与咨询、市场增长、人力与招聘、完整能力包——也可以自行组合 24 个原子 Skill。详见[完整能力地图、每项 Skill 和端到端工作流示例](CAPABILITIES.zh-CN.md)。
...
CAPABILITIES*.md  24 个 Skill、7 个工作包和组合工作流示例
ROADMAP*.md   从 Alpha 到稳定生态的证据门槛路线图
```

## 路线图

下一个证据里程碑是 `v0.3`：完成母语人工签署审校、三语模型实跑评测、全部发布目标原生实跑，以及首次签名预发布。详见[完整的证据门槛路线图](ROADMAP.zh-CN.md)。
