...
MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "setup_complete": "AnyWork is ready: {skills} capabilities installed for {agents} agent targets.",
    ...
    "zh-CN": {
        ...
        "setup_complete": "AnyWork 已就绪：已安装 {skills} 项能力，覆盖 {agents} 个智能体目标。",
    ...
    "ja": {
        ...
        "setup_complete": "AnyWork の準備が完了しました：{skills} 能力を {agents} 個のエージェント対象へ導入しました。",
...
CLI_HELP: dict[str, dict[str, str]] = {
    "en": {
        ...
        "setup": "install every capability and the orchestrator in one step",
        "demo": "show a ready-to-run end-to-end work example",
    ...
    "ja": {
        ...
        "setup": "全能力とオーケストレーターを一度に導入",
        "demo": "そのまま使えるエンドツーエンド業務例を表示",
        "install": "パックをインストール",
